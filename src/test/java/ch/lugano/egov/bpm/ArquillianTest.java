...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "offset-date-time";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "offset-date-time.war")
            ...
            .addPackages(false, "ch.lugano.egov.bpm") // not recursive to skip package 'nonarquillian'
